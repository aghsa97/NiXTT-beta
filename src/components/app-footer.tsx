...
function AppFooter() {
    return (
        <footer className='flex items-center border border-neutral-200 rounded-full px-4 py-2 mb-2 max-w-screen-sm mx-auto gap-1'>
            <svg width="43" height="20" viewBox="0 0 253 70" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <p className='text-neutral-950/60 text-sm font-semibold'>made with <span className='text-red-500'>♥</span> by
                <span className='mr-1'> <a href="https://www.linkedin.com/in/mohammed-agha/" target={'_blank'} className="underline text-neutral-950 hover:no-underline">@agha</a> </span>
                •
                <span className='mx-2'>See on <a href="https://github.com/aghsa97/factum" target={'_blank'} className="underline text-neutral-950 hover:no-underline">Github</a></span>
                ©2023
            </p>
        </footer>
    )
